...
↑ **Parent:** [Table relationship](table-relationship.md)  
ⓦ [Wiki](https://en.wikipedia.org/wiki/One-to-many_(data_model))

## ↑ Ancestors (9)

1. [Table relationship](table-relationship.md)
2. [Database feature](database-feature.md)
