...
↑ **Parent:** [Keyboard layout](keyboard-layout.md)  
ⓦ [Wiki](https://en.wikipedia.org/wiki/QWERTY)

## ↑ Ancestors (11)

1. [Keyboard layout](keyboard-layout.md)
2. [Computer keyboard](computer-keyboard.md)
3. [Peripheral](peripheral.md)
4. [I/O device](i-o-device.md)
