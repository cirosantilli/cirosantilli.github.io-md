...
↑ **Parent:** [Ordered and unordered trees](ordered-and-unordered-trees.md)  
ⓦ [Wiki](https://en.wikipedia.org/wiki/Tree_(data_structure)#Ordered_tree)
...
1. [Ordered and unordered trees](ordered-and-unordered-trees.md)
2. [Tree type](tree-type.md)
