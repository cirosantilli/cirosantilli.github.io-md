...
↑ **Parent:** [Python standard library](python-standard-library.md)
...
1. [Python standard library](python-standard-library.md)
2. [Python (programming language)](python-programming-language.md)
