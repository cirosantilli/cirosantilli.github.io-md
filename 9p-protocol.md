...
↑ **Parent:** [Clustered file system](clustered-file-system.md)  
ⓦ [Wiki](https://en.wikipedia.org/wiki/9P_(protocol))

## ↑ Ancestors (12)

1. [Clustered file system](clustered-file-system.md)
2. [Filesystem](filesystem.md)
3. [Computer data storage software](computer-data-storage-software.md)
