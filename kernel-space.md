...
↑ **Parent:** [User and kernel space](user-and-kernel-space.md)

## ↑ Ancestors (10)

1. [User and kernel space](user-and-kernel-space.md)
2. [Operating system concept](operating-system-concept.md)
