...
↑ **Parent:** [Discrete and integrated GPUs](discrete-and-integrated-gpus.md)

## ↑ Ancestors (11)

1. [Discrete and integrated GPUs](discrete-and-integrated-gpus.md)
2. [Graphics processing unit](graphics-processing-unit.md)
3. [Type of processor](type-of-processor.md)
