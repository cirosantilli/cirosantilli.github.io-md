...
↑ **Parent:** [List of phase transitions](list-of-phase-transitions.md)  
ⓦ [Wiki](https://en.wikipedia.org/wiki/Sublimation_(phase_transition))

## ↑ Ancestors (8)

1. [List of phase transitions](list-of-phase-transitions.md)
2. [Phase (matter)](phase-matter.md)
3. [Thermodynamics](thermodynamics.md)
