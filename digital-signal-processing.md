...
↑ **Parent:** [Signal processing](signal-processing.md)  
ⓦ [Wiki](https://en.wikipedia.org/wiki/Digital_signal_processing)

## ↑ Ancestors (7)

1. [Signal processing](signal-processing.md)
2. [Information theory](information-theory.md)
