...
↑ **Parent:** [Renormalization](renormalization.md)  
ⓦ [Wiki](https://en.wikipedia.org/wiki/Yang–Mills_theory)

**Table of contents**

- [Yang-Mills existence and mass gap](yang-mills-existence-and-mass-gap.md)
  - [Wightman axioms](wightman-axioms.md)

## ↑ Ancestors (10)

1. [Renormalization](renormalization.md)
2. [Mathematical formulation of quantum field theory](mathematical-formulation-of-quantum-field-theory.md)
