<h1 id="folding-at-home">Folding@home</h1>

↑ **Parent:** [Fog computing](fog-computing.md)  
ⓦ [Wiki](https://en.wikipedia.org/wiki/Folding@home)

## ↑ Ancestors (9)

1. [Fog computing](fog-computing.md)
2. [Distributed computing](distributed-computing.md)
