...
A memorable quote from [Tinker Tailor Soldier Spy](tinker-tailor-soldier-spy.md):

> [Haydon](bill-haydon.md) \[the [Soviet](soviet-union.md) [mole](mole-espionage.md)\] also took it for granted that [secret services](secret-service.md) were the only real measure of a nation's political health, the only real expression of its subconscious.
