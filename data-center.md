...
↑ **Parent:** [Server (computing)](server-computing.md)  
ⓦ [Wiki](https://en.wikipedia.org/wiki/Data_center)

## ↑ Ancestors (8)

1. [Server (computing)](server-computing.md)
2. [Networking hardware](networking-hardware.md)
