<h1 id="_file/nodejs/sequelize/raw/trigger_count.js">nodejs/sequelize/raw/trigger_count.js</h1>

↑ **Parent:** [ISO SQL TRIGGER syntax](../../../../iso-sql-trigger-syntax.md)

In this example we cache track the number of posts per user on a cache column.

## ↑ Ancestors (13)

1. [ISO SQL TRIGGER syntax](../../../../iso-sql-trigger-syntax.md)
