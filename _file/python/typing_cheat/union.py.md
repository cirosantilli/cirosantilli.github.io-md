<h1 id="_file/python/typing_cheat/union.py">python/typing_cheat/union.py</h1>

↑ **Parent:** [Python `typing`](../../../python-typing.md)

## ↑ Ancestors (11)

1. [Python `typing`](../../../python-typing.md)
2. [Python standard library](../../../python-standard-library.md)
