...
↑ **Parent:** [Spin number of a field](spin-number-of-a-field.md)

Theorized for the [graviton](graviton.md).

## ↑ Ancestors (10)

1. [Spin number of a field](spin-number-of-a-field.md)
2. [Spin (physics)](spin-physics.md)
3. [Dirac equation](dirac-equation.md)
