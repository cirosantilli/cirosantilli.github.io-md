...
↑ **Parent:** [Transformation (genetics)](transformation-genetics.md)  
ⓦ [Wiki](https://en.wikipedia.org/wiki/Avery–MacLeod–McCarty_experiment)

## ↑ Ancestors (9)

1. [Transformation (genetics)](transformation-genetics.md)
2. [Horizontal gene transfer](horizontal-gene-transfer.md)
3. [DNA](dna-split.md)
