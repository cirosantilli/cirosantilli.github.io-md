...
↑ **Parent:** [Named algebraic equation](named-algebraic-equation.md)  
...
1. [Named algebraic equation](named-algebraic-equation.md)
2. [Algebraic equation](algebraic-equation.md)
3. [Polynomial](polynomial.md)
