...
↑ **Parent:** [Quantum electrodynamics](quantum-electrodynamics.md)  
ⓦ [Wiki](https://en.wikipedia.org/wiki/Wheeler–Feynman absorber theory)

What they presented on [richard Feynman's first seminar in 1941](richard-feynman-s-first-seminar-in-1941.md). Does not include [quantum mechanics](quantum-mechanics-split.md) it seems.

## ↑ Ancestors (9)

1. [Quantum electrodynamics](quantum-electrodynamics.md)
