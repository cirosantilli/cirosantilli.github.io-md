...
Physics (like all well done [science](science-split.md)) is the [art](art-split.md) of predicting the future by modelling the world with [mathematics](mathematics-split.md).

And predicting the future is the first step towards [controlling](control-engineering.md) it, i.e.: [engineering](engineering.md).

[Ciro Santilli](ciro-santilli-split.md) doesn't know physics. He writes about it partly to start playing with some scientific content for: [OurBigBook.com](ourbigbook-com-split.md), partly because this stuff is just amazingly beautiful.

Ciro's main intellectual [physics](physics-split.md) [fetishes](fetish.md) are to learn [quantum electrodynamics](quantum-electrodynamics.md) (understanding the point of [Lie groups](lie-group.md) being a subpart of that) and [condensed matter physics](condensed-matter-physics-split.md).

Every science [is Physics in disguise](reductionism.md), but the number of objects in the real world is so large that we can't solve the real equations in practice.

Luckily, due to [emergence](emergence.md), we can use uglier higher level approximations of the world to solve many problems, with the complex limits of applicability of those approximations.
...
- the [Standard Model](standard-model-split.md)
- [general relativity](general-relativity.md)

Unifying those two into the [theory of everything](theory-of-everything.md) one of the major goals of modern physics.
...
**[Figure 1](#image-xkcd-435-fields-arranged-by-purity). xkcd 435: Fields arranged by purity**. [Source](https://xkcd.com/435/). [Reductionism](reductionism.md) comes to mind.
...
- [How to teach and learn physics](how-to-teach-and-learn-physics.md)
  ...
  - [Doing physics means calculating a number](doing-physics-means-calculating-a-number.md)
    - [Physics is a way to predict the future](physics-is-a-way-to-predict-the-future.md)
  - [It is OK to treat things as black boxes](it-is-ok-to-treat-things-as-black-boxes.md)
- [The most important physics experiments](the-most-important-physics-experiments.md)
  - [Physics experiment without a decent modern video](physics-experiment-without-a-decent-modern-video.md)
...
- [Energy](energy.md)
  - [Unit of measurement for energy](unit-of-measurement-for-energy.md)
    - [Joule](joule.md)
    - [Watt](watt.md)
  - [Conservation of energy](conservation-of-energy.md)
  - [Potential energy](potential-energy.md)
    - [Potential barrier](potential-barrier.md)
  - [Kinetic energy](kinetic-energy.md)
    - [Why kinetic energy is $mv^2/2$?](why-kinetic-energy-is-mv-2-2.md)
  - [Work (physics)](work-physics.md)
    - [Why work is force times distance?](why-work-is-force-times-distance.md)
- [Experimental physics](experimental-physics.md)
  - [Theoretical physics](theoretical-physics.md)
- [Field (physics)](field-physics.md)
  - [Principle of locality](principle-of-locality.md)
    - [Causality](causality.md)
      - [Causality in quantum mechanics](causality-in-quantum-mechanics.md)
        - [Causality and quantum jumps are incompatible](causality-and-quantum-jumps-are-incompatible.md)
- [Law of physics](law-of-physics.md)
...
- [Computational physics](computational-physics.md)
  - [Computational chemistry](computational-chemistry.md)
    - [Quantum chemistry](quantum-chemistry.md)
      - [Relativistic quantum chemistry](relativistic-quantum-chemistry.md)
      - [Quantum chemistry software](quantum-chemistry-software.md)
        - [PySCF](pyscf.md)
        - [Psi4](psi4.md)
    - [Quantum computing computational chemistry algorithms](quantum-computing-computational-chemistry-algorithms.md)
      - [IBM 2017 beryllium hydride ground state calculation on a quantum computer](ibm-2017-beryllium-hydride-ground-state-calculation-on-a-quantum-computer.md)
- [Physics conference](physics-conference.md)
  - [Solvay Conference](solvay-conference.md)
    - [First Solvay Conference (1911)](first-solvay-conference-1911.md)
    - [Fifth Solvay Conference (1927)](fifth-solvay-conference-1927.md)
  - [Shelter Island Conference](shelter-island-conference.md)
    - [Pocono conference](pocono-conference.md)
...
- [Physics gossip](physics-gossip.md)
- [Unsolved physics problem](unsolved-physics-problem.md)
- [Physics bibliography](physics-bibliography.md)
  - [Theoretical Physics Reference by Ondrej Certík](theoretical-physics-reference-by-ondrej-certik.md)
  - [Physics YouTube channel](physics-youtube-channel.md)
    - [Faculty of Khan](faculty-of-khan.md)
    - [Looking Glass Universe](looking-glass-universe.md)
    - [Ludic Science](ludic-science.md)
    - [minutephysics](minutephysics.md)
    - [Physics Explained](physics-explained.md)
    - [ScienceClic](scienceclic.md)
    - [Steve Mould](steve-mould.md)
    - [The Science Asylum](the-science-asylum.md)
      - [Nick Lucid](nick-lucid.md)
    - [UCSB Physics Lecture Demonstrations](ucsb-physics-lecture-demonstrations.md)
    - [UNSW Physics YouTube channel](unsw-physics-youtube-channel.md)
    - [Veritasium](veritasium.md)
  - [Physics journal](physics-journal.md)
    - [Physics Letters](physics-letters.md)
      - [Physics Letters A](physics-letters-a.md)
      - [Physics Letters B](physics-letters-b.md)
    - [Journal by the American Physical Society](journal-by-the-american-physical-society.md)
      - [Physical Review](physical-review.md)
        - [Paper published on Physical Review ](paper-published-on-physical-review.md)
      - [Physical Review Letters](physical-review-letters.md)
        - [Physical Review Letters article](physical-review-letters-article.md)
