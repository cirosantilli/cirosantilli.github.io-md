...
↑ **Parent:** [AWS service](aws-service.md)  
ⓦ [Wiki](https://en.wikipedia.org/wiki/Amazon_Athena)

[Google BigQuery](google-bigquery.md) alternative.

## ↑ Ancestors (11)

1. [AWS service](aws-service.md)
2. [Amazon Web Services](amazon-web-services.md)
3. [Cloud computing platform](cloud-computing-platform.md)
