...
↑ **Parent:** [Computer data storage hardware](computer-data-storage-hardware.md)  
...
1. [Computer data storage hardware](computer-data-storage-hardware.md)
2. [Computer data storage](computer-data-storage.md)
3. [I/O device](i-o-device.md)
