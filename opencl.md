...
↑ **Parent:** [GPU compute library](gpu-compute-library.md)  
ⓦ [Wiki](https://en.wikipedia.org/wiki/OpenCL)

## ↑ Ancestors (12)

1. [GPU compute library](gpu-compute-library.md)
2. [General-purpose computing on graphics processing units](general-purpose-computing-on-graphics-processing-units.md)
3. [Graphics processing unit](graphics-processing-unit.md)
