...
↑ **Parent:** [Rack server](rack-server.md)  
ⓦ [Wiki](https://en.wikipedia.org/wiki/19-inch_rack)

## ↑ Ancestors (10)

1. [Rack server](rack-server.md)
2. [Server form factor](server-form-factor.md)
3. [Server (computing)](server-computing.md)
