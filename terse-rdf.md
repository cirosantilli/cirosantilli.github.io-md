...
↑ **Parent:** [RDF language](rdf-language.md)  
ⓦ [Wiki](https://en.wikipedia.org/wiki/Turtle_(syntax))

## ↑ Ancestors (10)

1. [RDF language](rdf-language.md)
2. [Resource Description Framework](resource-description-framework.md)
3. [Knowledge graph](knowledge-graph.md)
4. [Ontology](ontology.md)
