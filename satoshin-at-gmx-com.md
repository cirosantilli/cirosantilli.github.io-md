<h1 id="satoshin-at-gmx-com">satoshin@gmx.com</h1>

↑ **Parent:** [Satoshi's email address](satoshi-s-email-address.md)

One of [Satoshi's email addresses](satoshi-s-email-address.md), this one is given on the [Bitcoin whitepaper](bitcoin-whitepaper.md).
...
1. [Satoshi's email address](satoshi-s-email-address.md)
