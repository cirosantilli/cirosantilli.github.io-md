...
[Ciro Santilli](ciro-santilli-split.md) often wonders to himself, how much of the natural sciences can one learn in a lifetime? Certainly, a very strong basis, with concrete experimental and [physics](physics-split.md), [chemistry](chemistry-split.md) and [biology](biology-split.md) should be attainable to all? How much Ciro manages to learning and teach in those areas is a kind of success metric of Ciro's life.
